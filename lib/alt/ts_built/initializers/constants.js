...
var Constants = (function () {
    ...
    Object.defineProperty(Constants, "tableMaps", {
        get: function () {
            return [
...
exports.detectMapMap = function (key) { return _.find(exports.allMaps, function (m) { return m.key == key; }); };
exports.detectCategoryName = function (key) { return exports.detectMapMap(key).name; };
exports.detectMap = function (key) { return exports.detectMapMap(key).value; };
exports.detectCategoryDetailMap = function (categoryKey, detail) {
    var category = _.find(exports.allMaps, function (_a) {
        var key = _a.key;
