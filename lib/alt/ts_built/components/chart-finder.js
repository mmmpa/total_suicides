...
var ChartFinderComponent = (function (_super) {
    ...
    ChartFinderComponent.prototype.selectableKeys = function (target) {
        ...
        var metas = constants_1.default.metas, tables = constants_1.default.tables;
        var all = [metas, tables];
        switch (target) {
            case 'table':
                return all;
            case 'x':
                if (this.isTable(table)) {
                    ...
                    return [_.filter(metas, function (_a) {
                            var key = _a.key;
                            return key != table;
                        }), tables];
                }
    ...
    ChartFinderComponent.prototype.writeAllSelector = function (target, placeholder, suffix) {
        ...
        var labels = ['大分類', '詳細'];
        return React.createElement("select", {"className": "chart-finder selector", "ref": target, "key": target + "list", "defaultValue": this.state[target], "onChange": function (e) { return _this.change(target, e.target.value); }}, React.createElement("option", {"name": target, "value": 'none', "key": target + "-default", "className": "placeholder"}, placeholder), _.map(selectable, function (group, i) {
