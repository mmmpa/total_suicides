...
var StackBarChartComponent = (function (_super) {
    ...
    StackBarChartComponent.prototype.writeTables = function (tableList, max) {
        ...
        return _.map(tableList, function (_a) {
            ...
            return React.createElement("section", {"className": "chart-list chart-block", "key": table.title}, React.createElement("h1", null, table.title), _this.writeChart(chart, max), _this.writeTable(table));
        });
    };
    StackBarChartComponent.prototype.render = function () {
        ...
        if (!tableListList || !tableListList.length || _.isString(tableListList)) {
            return React.createElement("article", {"className": "chart-list body"}, React.createElement("div", {"className": "loading"}, React.createElement(fa_1.default, {"icon": "spinner", "pulse": true}), "loading..."));
        }
        ...
        return React.createElement("div", null, React.createElement("article", {"className": "chart-list body"}, tableListList.map(function (_a) {
            ...
            return React.createElement("section", {"className": "chart-list chart-line", "key": title}, React.createElement("h1", {"className": "chart-list chart-title"}, title), _this.writeTables(tables, max));
        })));
    };
