...
rails g model job gender:references area:references year:references self_employed:integer employed:integer total_unemployed:integer student:integer unemployed:integer stay_at_home:integer pensioner:integer unknown:integer
